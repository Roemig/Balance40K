...
<gameSystem xmlns="http://www.battlescribe.net/schema/gameSystemSchema" id="sys-68cc-5ca8-f046-3e5c" name="Warhammer 40,000 10th Edition, but balanced" revision="37" battleScribeVersion="2.03" type="gameSystem">
  <publications>
    <publication id="48fc-15aa-b307-9443" name="10th Edition Core Balance Rules" shortName="10th Ed Core Balance"/>
