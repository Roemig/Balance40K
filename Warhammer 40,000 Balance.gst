...
<gameSystem xmlns="http://www.battlescribe.net/schema/gameSystemSchema" id="sys-352e-adc2-7639-d6a9" name="Warhammer 40,000 10th Edition, but balanced" revision="74" battleScribeVersion="2.03" type="gameSystem">
  <publications>
    <publication id="48fc-15aa-b307-9443" name="10th Edition Core Rules Balance" shortName="10th Ed Core Balance"/>
    <publication name="Github" hidden="false" id="8db3-575d-91b-47f8" shortName="BSData/Balance40K" publisherUrl="https://github.com/Roemig/Balance40K"/>
  </publications>
  <costTypes>
